...
class ManagementEnforcerTest extends TestCase
{
    ...
    public function testupdateFilteredPolicies()
    {
        ...
        $testAdapter->shouldReceive('updateFilteredPolicies')->once()->with('p', 'p', $newPolicies, 1, 'bob', 'data2', 'write', 'alice', 'data1', 'read')->andReturn($oldPolicies);
        $e->updateFilteredPolicies($newPolicies, 1, 'bob', 'data2', 'write', 'alice', 'data1', 'read');
